...
if(!toggle) {if(timer[@ 0] > timer[@ 1]) {return 0}} //if not toggle mode, timer will output 1 once and then 0

timer[@ 0]++
if(timer[@ 0] <= (timer[@ 1]) ) {timer[@ 0]++}
if(timer[@ 0] > timer [@ 1]) {return 1} else{return 0}

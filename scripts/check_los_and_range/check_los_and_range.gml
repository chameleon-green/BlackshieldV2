...
function check_los_and_range(ai_enabled,ix,iy,target,wall_object,max_range)
{
	...
	var half_target_height = (target.bbox_top - target.bbox_bottom)/2 //gets half of target height
	...
	var LOS = collision_line(x,yyy,target.x,pl_offset-half_target_height,wall_object,true,1)
	var LOS2 = collision_line(x,yyy,target.x,pl_offset+half_target_height,wall_object,true,1)
